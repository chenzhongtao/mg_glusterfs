...
CONFIG_CLEAN_FILES = contrib/uuid/uuid_types.h glusterfs-api.pc \
	libgfchangelog.pc glusterfs.spec tests/env.rc
...
PACKAGE_RELEASE = 0
PACKAGE_STRING = glusterfs 3.6.1
...
ZLIB_CFLAGS =  
ZLIB_LIBS = -lz  
abs_builddir = /home/code/github/mg_glusterfs
abs_srcdir = /home/code/github/mg_glusterfs
abs_top_builddir = /home/code/github/mg_glusterfs
abs_top_srcdir = /home/code/github/mg_glusterfs
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
am__leading_dot = .
...
initdir = /etc/init.d
install_sh = ${SHELL} /home/code/github/mg_glusterfs/install-sh
...
SUBDIRS = $(ARGP_STANDALONE_DIR) libglusterfs rpc api xlators glusterfsd \
	$(FUSERMOUNT_SUBDIR) doc extras cli geo-replication \
